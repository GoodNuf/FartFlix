...
<template>
  <WelcomeItem>
    ...
    <h4 style="color:white;">FartFlix<span style="color:#69CCC9;">+</span> Monthly</h4>1,800+ movies & 15,000+ episodes of TV + 1 monthly request: <br>$<span style="color:#69CCC9;">6</span>/month<sup>1</sup></br>
    <h4 style="color:white;">FartFlix<span style="color:#69CCC9;">+</span> Annual</h4>1,800+ movies & 15,000+ episodes of TV + 1 monthly request: <br>$<span style="color:#69CCC9;">55</span>/year<sup>1</sup>
  </WelcomeItem>
  <WelcomeItem>
    <template #icon>
      <CatalogIcon />
